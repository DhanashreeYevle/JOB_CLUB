...
<center><form action="userupdates.jsp" method="post">
<table>
	...
	<c:forEach var="table" items="${rs.rows}">
		...
		<tr><th>Password:</th> <td><input type="text" value="${table.password}" name="password"/></td></tr>
...
</table><br><center><input type="submit" value="Save" class="update"/></center>
<a href="display.jsp">Back to Home</a>
</form></center>
</body>
</html>