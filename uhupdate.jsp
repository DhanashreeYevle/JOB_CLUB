...
<center><form action="uhupdates.jsp" method="post">
<table>
	 <h2 style="color:#4CAF50">Update Details</h2>

	<c:forEach var="table" items="${rs.rows}">
		<tr><th>Applied On:</th>  <td><input type="text" value="${table.time}" name="time" disabled/>	</td></tr>
		<tr><th>WorkID:</th>  <td><input type="text" value="${param.w_id}" name="w_id" /></td></tr>
		<tr><th>App_ID:</th> <td><input type="text" value="${table.a_id}" name="a_id" disabled/></td></tr>
		<tr><th>App_Name:</th> <td><input type="text" value="${table.app_name}" name="app_name" disabled/></td></tr>
...
<a href="Userhistory.jsp">Back to Records</a>
</form></center>
</body>
</html>